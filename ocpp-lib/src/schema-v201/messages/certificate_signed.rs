//! CertificateSigned
use crate::v201::datatypes::status_info_type::StatusInfoType;
use crate::v201::enumerations::certificate_signed_status_enum_type::CertificateSignedStatusEnumType;
use crate::v201::enumerations::certificate_signing_use_enum_type::CertificateSigningUseEnumType;
...
pub struct CertificateSignedRequest {
    ...
    /// was included in the [SignCertificateRequest](`crate::v201::messages::sign_certificate::SignCertificateRequest`)
